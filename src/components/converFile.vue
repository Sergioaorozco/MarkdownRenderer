...
<template>
  <main class="wrapper text-center py-10 flex justify-center flex-col gap-y-10 w-full">
    ...
    <button @click="convertMarkDown" class="bg-orange-600 hover:bg-orange-700 text-slate-700 transition-colors duration-200 font-bold py-3 rounded-lg" :class="{'bg-slate-600/30 text-slate-400 pointer-events-none' : !isMDX}">{{!isMDX ?
